...
def ClientsFinder(Queries, Cities, Location, Clients, Address, Lat, Long):
    ...
    for page in pages:
        ...
        URL = 'https://www.paginegialle.it/ricerca/{}/{}{}'.format(Query, City, page)
        ...
        location = [City for i in range(len(clients))]
        Location += location
            

    
City = 'Faenza'
query = 'arredo su misura'
if ' ' in query:
...
ClientsFinder(Query, City, Location, Clients, Address, Lat, Long)   
